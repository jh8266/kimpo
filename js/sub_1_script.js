...
//function page() {
//    var req_num_row = 7; //한 페이지에 나타낼 데이터 수
//    var pageCount = 10; // 한 페이지에 나타낼 페이지 수
//    var $tr = $('tbody tr'); // 총 데이터 수
//    var total_num_row = $tr.length;
//    var num_pages = 1;
//    if (total_num_row % req_num_row == 0) {
//        num_pages = total_num_row / req_num_row;
//        console.log("num_pages_0", num_pages);
//    }
//    if (total_num_row % req_num_row >= 1) {
//        num_pages = total_num_row / req_num_row;
//        num_pages++;
...
//        if (num_pages >= 11) {
//            console.log("aa");
//            for (var i = 11; i < num_pages; i++) {
//                console.log(i);
//                $(`.page li:nth-child(${i})`).css("color", "red");
//                console.log($(".page")[0].children);
//            }
//    }
//
//     $('.page').append("<li><a class=\"prev\"></a></li>");
//
//    for (var i = 1; i <= num_pages; i++) {
//        if (i == 1) {
//            $('.page').append("<li><a href=\"#\" class=\"active\">" + i + "</a></li>");
//        } else {
//            $('.page').append("<li><a href=\"#\">" + i + "</a></li>");
//        }
//        $('.page li:nth-child(2)').addClass("active");
//
//        $('.page a').addClass("pagination-link");
//
//    }
//
//     $('.page').append("<li><a class=\"next\"></a></li>");
//
//    $tr.each(function (i) {
//        $(this).hide();
//        if (i + 1 <= req_num_row) {
...
//        }
//    });
//    $('.page a').click('.pagination-link', function (e) {
//        e.preventDefault();
//        $tr.hide();
//        var page = $(this).text();
//        var temp = page - 1;
