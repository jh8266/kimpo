    ...
    $('.paginated').each(function () {
        ...
        $table.bind('repaginate', function () {
            ...
            if (numPages > 1) { // 한페이지 이상이면
                if (currentPage < 4 && numPages - currentPage >= 4) { // 현재 5p 이하이면
                    nowp = 0; // 1부터
                    endp = pagesu; // 10까지
                } else {
...
$(function () {
    ...
    $(".infobtn button").on("click", function(){
        $(".infopop").addClass("active");
    });
    
    $(".infopop button").on("click", function(){
        $(".compop").addClass("active")
    });
    ...
    $(".infopop .closebtn2").on("click", function () {
        $(".infopop").removeClass("active");
    });
    
    $(".compop .closebtn3").on("click", function(){
        $(".compop").removeClass("active");
    })
});
